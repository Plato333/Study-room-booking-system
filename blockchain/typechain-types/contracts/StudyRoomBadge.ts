...
export interface StudyRoomBadgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "hasMintedBatch",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
...
export interface StudyRoomBadge extends BaseContract {
  connect(runner?: ContractRunner | null): StudyRoomBadge;
  waitForDeployment(): Promise<this>;

  interface: StudyRoomBadgeInterface;
  ...
  hasMinted: TypedContractMethod<[account: AddressLike], [boolean], "view">;

  hasMintedBatch: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "hasMintedBatch"
  ): TypedContractMethod<[addresses: AddressLike[]], [boolean[]], "view">;
  getFunction(
